...
- <font size="2">3. Construye tu equipo de manera consciente. Usa herramientas para compartir codigo/archivos.</font>
- <font size="2">4. Investigación previa y profunda sobre el caso en concreto.</font>
- <font size="2">5. Análisis exploratorio de los datos. Recuerda que (usualmente) no son los únicos que puedes usar.</font>
- <font size="2">6. Establecer la estructura del proyecto y del código.</font>
- <font size="2">7. Lanzar los primeros modelos.</font>
...
- <font size="2">10. Escribir una memoria con puntos fuertes y puntos a mejorar detectados, que te sirvan de partida en el próximo reto.</font>
