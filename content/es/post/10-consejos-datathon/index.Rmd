...
- <font size="2">4. Investiga previa y profundamente sobre el caso de uso en concreto.</font>
...
- <font size="2">9. Interpretabilidad de modelos. Evaluación de resultados desde el punto de vista práctico y/o negocio.</font>
- <font size="2">10. Escribe una memoria con puntos fuertes y puntos a mejorar detectados, que te sirvan de de punto de partida en el próximo reto.</font>
...
Paquetes y módulos como SHAP o LIME incorporan métodos enfocados en la interpretabilidad de cada una de las predicciones. Esto supone un paso más allá a la hora de interpretar nuestros modelos, ya que además de la importancia global "media" de cada variable en el modelo, obtenida en los coeficientes o por métricas como la importancia de variables que suelen traer los algoritmos de árboles y bagging/boosting, podemos obtener el peso de cada variable en una observación específica del set de test.
