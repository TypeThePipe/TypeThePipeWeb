...
```
```{r, include=FALSE}
nchar("Setting up the interactive grid with R Shiny and ggplot! Trial with some kind of random-walker algorithm.")
```

<img src="/en/post/pathfinding-algorithms-visualizer-using-r/featured.png" height="250px" width="400px" alt="R Shiny and GGplot2 pathfinding algorithm exploring grid map. It's an interactive ggplot2 plot." />
...
You can find the Pathfinding Visualization using R series on [TypeThePipe](https://typethepipe.com)
