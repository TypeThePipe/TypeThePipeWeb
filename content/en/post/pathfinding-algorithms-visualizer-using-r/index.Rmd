...
<img src="/en/post/pathfinding-algorithms-visualizer-using-r/featured.gif" height="250px" width="400px" alt="R Shiny and GGplot2 pathfinding algorithm exploring grid map. It's an interactive ggplot2 plot." />
