---
title: "Ggplot2: Tidy evaluation and reference columns from variables"
...
subtitle: 'How to write clean and modular code with the curly-curly operator. Easily plotting columns dynamically from string variables by using tidy evaluation.'
summary: 'How to write clean and modular code with the curly-curly operator. Easily plotting columns dynamically from string variables by using tidy evaluation.'
authors: [pablo-canovas]
---

```{r, include=FALSE}
nchar("Programming with ggplot - Reference columns from variables") # max 60-70
nchar("How to write clean and modular code with the curly-curly operator. Easily plotting columns dynamically from string variables by using tidy evaluation.") # at least 120 to 160
```
