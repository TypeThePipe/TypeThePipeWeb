---
title: "Energy forecasting error metrics"
...
categories:
  ...
  - Post
tags: []
subtitle: 'A discussion about the main error metrics and their properties.'
summary: 'A discussion about the main error metrics and their properties'
...
However, against all odds [Symmetric MAPE is not symmetric](../symmetric-mape-is-not-symmetric/index.Rmd): as MAPE, it may present different values for the same absolute deviation: 
...
You can read a brief description in the [previously mentioned sMAPE article](../symmetric-mape-is-not-symmetric/index.Rmd) or 
