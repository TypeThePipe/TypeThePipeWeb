---
title: "Tidylog. Logging your pipelines"
author: "Pablo Cánovas Tourné"
date: "2020-01-21"
slug: "tidylog-logging-pipelines-r"
...
- Tips
tags: []
subtitle: "Do you find R Tidyverse pipelines useful? But do you need some kind of logging inside the fancy pipes? Here's Tidylog, logging your pipelines"
...
**We all love piping** operations. I often 'play' to perform the whole transformation [without leaving the pipeflow](../Conditional-pipes). But the counterpart is missing the intermediate states: you can make some big mistakes and be unaware of them until it's too late and maybe you have to undone some work or rethink your analysis.
