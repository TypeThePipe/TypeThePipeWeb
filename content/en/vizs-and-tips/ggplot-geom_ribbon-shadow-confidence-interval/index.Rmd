...
<img src="/en/vizs-and-tips/ggplot-geom_ribbon-shadow-confidence-interval/featured.png" height="250px" width="400px" alt="R ggplot2 plot of the forecast(in red) and it's condidence intervals(in blue) using geom_ribbon function." />
