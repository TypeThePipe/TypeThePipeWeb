---
title: "Select datetime columns matching their time zone with Polars Selectors and calculate offset with the new dst_offset. Python Polars series. "
author: "Carlos Vecina Tebar"
date: "2023-07-12"
slug: "python-polars-select-datetime-columns-python-polars-selector"
output:
  blogdown::html_page:
    highlight: tango
categories:
