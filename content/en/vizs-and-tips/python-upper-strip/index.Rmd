...
As we can see in the ``strip()` docstring, it accepts a string chain. To remove uppercases letters in the beginning and the end of a given string, we could make use of `string` module, and specifically, `string.ascii_uppercase` object.
