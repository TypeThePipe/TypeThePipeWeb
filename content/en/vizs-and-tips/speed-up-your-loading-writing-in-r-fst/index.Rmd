---
title: "Speed up your R scripts. A cool optimized way to load, write and store big files with FST package!"
author: Carlos Vecina Tebar
date: "2020-03-30"
slug: speed-up-load-write-files-fst-package-r
translationKey: "speed-up-load-write-files-fst-package-r"
output:
  blogdown::html_page:
    highlight: tango
categories:
- R
- Tips
tags: ["fst","dataloading"]
subtitle: "Unbeaten speed and file size! It's FST! x100 faster than write.csv()"
...
Are you trying to save and load your DL model or a big dataset? Here we show you a performance boost to your scripts and reduction in disk memory storage with the FST package. We are going to benchmark it with R base functions (csv and RDS extensions) and with another great package like readr:
