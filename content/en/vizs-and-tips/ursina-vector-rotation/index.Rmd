---
title: Ursina vector rotation. The right and easy way!
...
Let's get straight to the point. Although there are several ways to do it. Let's take a look at one that generally can be useful for us. We start rotating a simple vector using auxiliary functions. In the second part, we're exploring how to rotate a proper Ursina Entity. We're going to make our little cube do a mind-blowing pirouette.
