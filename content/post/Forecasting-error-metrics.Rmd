...
date: '2019-09-21'
slug: forecasting-error-metrics
output: 
  blogdown::html_page:
    toc: TRUE
    toc_depth: 2
...
However, against all odds [Symmetric MAPE is not symmetric](../Symmetric-MAPE-is-asymmetric): as MAPE, it may present different values for the same absolute deviation: 
